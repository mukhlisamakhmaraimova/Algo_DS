...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('news_title_uz', models.CharField(max_length=300, unique=True, verbose_name='Yangilik sarlavhasi')),
                ('news_title_en', models.CharField(max_length=300, unique=True, verbose_name='News title')),
                ('news_title_ru', models.CharField(max_length=300, unique=True, verbose_name='Заголовок новости')),
